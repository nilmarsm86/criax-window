...
qx.Class.define("inspector.objects.View",
{
  ...
  construct : function(controller)
  {
    ...
    if (qx.core.Environment.get("qx.debug")) {
      qx.core.Assert.assertInterface(controller, inspector.objects.Controller, "Invalid parameter 'controller'.");
    }
  ...
  members :
  {
    ...
    {
      if (qx.core.Environment.get("qx.debug")) {
        qx.core.Assert.assertInterface(model, qx.ui.table.ITableModel, "Invalid parameter 'model'.");
      }
    ...
    selectObject : function(object)
    {
      ...
      if (object != null && selectionModel.getSelectionMode() != qx.ui.table.selection.Model.NO_SELECTION)
      {
    ...
    __initialize : function()
    {
      ...
      //toolbar.setPaddingRight("5");

      // Creates the reload button
      var reload = new qx.ui.toolbar.Button(null, "icon/16/actions/view-refresh.png");
      reload.setMarginLeft(5);
      ...
      this.__hash = new qx.ui.toolbar.RadioButton("by Hash", "source/Modern/radio-checked.png");
      this.__hash.addListener("changeValue", function(event) {
        this.__hash.setIcon("source/Modern/" + ((event.getData()) ? "radio-checked" : "radio") + ".png");
      }, this);
      this.__hash.setAppearance(null);
      ...
      this.__count = new qx.ui.toolbar.RadioButton("by Count", "source/Modern/radio.png");
      this.__count.addListener("changeValue", function(event) {
        this.__count.setIcon("source/Modern/" + ((event.getData()) ? "radio-checked" : "radio") + ".png");
      }, this);
      this.__count.setAppearance(null);
