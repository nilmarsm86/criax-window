 ...
 * @asset(source/Modern/checkbox-checked.png)
 * @asset(source/Modern/checkbox.png)
 */
qx.Class.define("inspector.widgets.View",
{
  ...
  construct : function(inspectorModel)
  {
    ...
    this._reloadButton.setMarginLeft(5);
    ...
    this._structureToggle = new qx.ui.toolbar.CheckBox("Internal structure", "source/Modern/checkbox.png");
    this._structureToggle.addListener("changeValue", function(event) {
      this._structureToggle.setIcon("source/Modern/" + ((event.getData()) ? "checkbox-checked" : "checkbox") + ".png");
    }, this);
    this._structureToggle.setAppearance(null);
  ...
  members :
  {
    ...
    load : function(win)
    {
      ...
      if (remoteAppRoot.classname == "qx.ui.root.Application" || remoteAppRoot.classname == "qx.ui.mobile.core.Root")
      {
        var rootFolder = new qx.ui.tree.TreeFolder(remoteAppRoot.classname + " [" + remoteAppRoot.toHashCode() + "]");
      ...
      } else if (remoteAppRoot.classname == "qx.ui.root.Page")
      {
        ...
        var applicationRoot = new qx.ui.tree.TreeFolder(remoteAppRoot.classname + " [" + remoteAppRoot.toHashCode() + "]");
        ...
        for (var key in objects)
        {
          ...
          {
            var inlineRoot = new qx.ui.tree.TreeFolder(object.classname + " [" + object.toHashCode() + "]");
    ...
    _selectWidgetInTheTree : function(widget, toggleChildControl)
    {
      ...
      if (widget == null || ((this._iFrameWindow.qx.ui.core && this._iFrameWindow.qx.ui.core.Widget) && !(widget instanceof this._iFrameWindow.qx.ui.core.Widget)) || (this._iFrameWindow.qx.ui.mobile && !(widget instanceof this._iFrameWindow.qx.ui.mobile.core.Widget)))
      {
        this._tree.resetSelection();
        return;
      }
      ...
      if (this._structureToggle.isValue()) {
        ...
        while (w.getParent != undefined && w.getParent() != null || w.getLayoutParent() != null) {
      ...
      if (this._tree.getRoot().getUserData("instance") != null && this._tree.getRoot().getUserData("instance").toHashCode() == id)
      {
