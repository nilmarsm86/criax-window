...
qx.Class.define("inspector.console.AutoCompletePopup",
{
  ...
  */
  ...
  construct : function(main)
  {
    ...
    this._table.getTableColumnModel().setColumnWidth(1, 258);
  ...
  */
  ...
  {
    /**
     * ir a la siguiente fila por las teclas y hacer scroll
     */
    nextRow : function()
    {
      var maximo = this._table.getTableModel().getRowCount() - 1;
      var dataIndex;
      var dataNext;
      ...
      if (dataIndex < maximo)
      {
        this._table.getSelectionModel().setSelectionInterval(dataNext, dataNext);

        //TODO tener cuidado de no hacer scroll de mas
        this._table.getPaneScroller(0).setScrollY(this._table.getPaneScroller(0).getScrollY() + 20);
      }
    },

    /**
     * ir a la fila anterior por las teclas y hacer scroll
     */
    previousRow : function()
    {
      ...
      {
        this._table.getSelectionModel().setSelectionInterval(dataNext, dataNext);
        if (this._table.getPaneScroller(0).getScrollY() > 0) {
          this._table.getPaneScroller(0).setScrollY(this._table.getPaneScroller(0).getScrollY() - 20);
        }
      }
    },
    ...
    load : function(objectRef)
    {
      ...
      //qx.log.appender.Console.info(object);
