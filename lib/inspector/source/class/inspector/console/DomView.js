...
qx.Class.define("inspector.console.DomView",
{
  ...
  construct : function(console)
  {
    ...
    this._htmlEmbed = new qx.ui.embed.Html("<div class='ins_dom_no_prop'>No object selected.</div>");
    this._htmlEmbed.setOverflowY("scroll");
    this._add(this._htmlEmbed, {
      flex : 1
    });
  ...
  members :
  {
    ...
    getCurrentSelectedClassname : function()
    {
      ...
      if (this._breadCrumb.length > 0)
      {
        ...
        if (object.classname != undefined) {
          ...
          if (qx.Class.isDefined(object.classname) || qx.Interface.isDefined(object.classname) || qx.Mixin.isDefined(object.classname) || qx.Theme.isDefined(object.classname)) {
    ...
    _getHtmlToObject : function(o, index, name)
    {
      ...
      for (var i = 0; i < sortedValues.length; i++)
      {
        ...
        }catch (ex)
        {
          ...
          returnString.add("<tr><td class='" + keyStyle + "'><img class='ins_dom_front_image' src='" + imageURI + "'>" + this._console.escapeHtml(sortedValues[i].key) + "</td>");
          returnString.add("<td><span class='ins_dom_null'>" + sortedValues[i].value + "</span></td></tr>");
          continue;
        }

        // if it is not an object
        if (!(sortedValues[i].value instanceof this._iFrameWindow.Object) && sortedValues[i].value != this._iFrameWindow.window && sortedValues[i].value != this._iFrameWindow.document)
        {
          var imageURI = qx.util.ResourceManager.getInstance().toUri("inspector/images/spacer.gif");
          returnString.add("<tr><td class='" + keyStyle + "'><img class='ins_dom_front_image' src='" + imageURI + "'>" + this._console.escapeHtml(sortedValues[i].key) + "</td>");
        ...
        } else
        {
          ...
          if (sortedValues[i].value != o)
          {
            ...
            postString.add("<tr><td class='" + keyStyle + "'><a onclick='" + "qx.core.Init.getApplication().inspectObjectByDomSelecet(" + index + ", \"" + sortedValues[i].key + "\")" + "'><img class='ins_dom_front_image' src='" + imageURI + "'>" + this._console.escapeHtml(sortedValues[i].key) + "</a></td>");
          }
          ...
          if (sortedValues[i].value == o)
          {
            ...
            var imageURI = qx.util.ResourceManager.getInstance().toUri("inspector/images/spacer.gif");
            returnString.add("<tr><td class='ins_dom_key'><img class='ins_dom_front_image' src='" + imageURI + "'>" + sortedValues[i].key + "</td>");
    ...
    _sortAndFilterProperties : function(o)
    {
      ...
      for (var key in o) {
        try {
          ...
          {
            key : key,
            value : "Error occurs by reading value!"
          });
        }
      }
    ...
    _getReturnPath : function(index)
    {
      ...
      for (var i = 0; i <= index; i++)
      {
        ...
        if (i == index) {
          ...
          returnString.add(" &raquo; <span class='ins_dom_return_path_link' onclick='" + "qx.core.Init.getApplication().inspectObjectByDomSelecet(" + i + ")'>");
        }
    ...
    {
      var returnString = new qx.util.StringBuilder();
      returnString.add("<a onclick='" + "qx.core.Init.getApplication().inspectObjectByDomSelecet(" + index + ", \"" + key + "\")" + "'>");
      ...
      {
        returnString.add(object + "</a> <a style='color: #000000;' onclick=\"qx.core.Init.getApplication().setWidgetByHash('" + object.toHashCode() + "', 'console');\">select Object</u>");
