...
qx.Class.define("inspector.test.components.InspectorModel",
{
  ...
  members :
  {
    ...
    testGetObjects : function()
    {
      ...
      this.assertArrayEquals([objects["o2"], objects["o3"]], this.__model.getObjects());
    },
    testGetRoots : function() {
      try
      {
        ...
        this.__model.setWindow(windowMock);
        this.assertArrayEquals([root, objects["o2"], objects["o4"]], this.__model.getRoots());
      }catch (ex) {
        throw new Error(ex);
      }
      {
    ...
    testSetInspected : function()
    {
      ...
      this.assertEquals(newObject, this.__model.getInspected());
    },
    testChangeInspectedEvent : function()
    {
      ...
      {
        that.assertEquals(newObject, event.getData());
        that.assertEquals(oldObject, event.getOldData());
      });
