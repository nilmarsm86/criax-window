...
qx.Class.define("inspector.test.objects.Model",
{
  ...
  members :
  {
    ...
    {
      this.assertNull(this.__model.getInspected(), "Initial inspected object is wrong.");
      this.assertArrayEquals([], this.__model.getObjects(), "Initial objects are wrong.");
    },
    testGetInspected : function()
    {
      var testObject = new qx.core.Object();
      this.__mockObject.setInspected(testObject);
      this.assertEquals(testObject, this.__model.getInspected(), "Model doesn't know about change in inspector.");
      testObject.dispose();
    },
    testSetInspected : function()
    {
      ...
      this.assertEquals(testObject, this.__model.getInspected(), "Model has not the correct object.");
      this.assertEquals(testObject, this.__mockObject.getInspected(), "Mock has not the correct object.");
      testObject.dispose();
    },
    testChangeInspectedFromInpector : function()
    {
      ...
      }, function(event)
      {
        ...
        that.assertEquals(testObject, newInspected, "The new inspected object is incorrect.");
      });
      testObject.dispose();
    },
    ...
    testGetObjects : function()
    {
      ...
      this.assertArrayEquals(objects, this.__model.getObjects(), "Objects are wrong.");
      objects[0].dispose();
      objects[1].destroy();
    },
    testChangeObjects : function()
    {
      ...
      this.assertEventFired(this.__model, "changeObjects", function() {
        ...
        that.assertArrayEquals(objects, event.getTarget().getObjects(), "Objects are wrong.");
      });
      objects[0].dispose();
      objects[1].destroy();
    }
