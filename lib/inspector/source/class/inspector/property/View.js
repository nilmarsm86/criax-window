...
qx.Class.define("inspector.property.View",
{
  ...
  members :
  {
    ...
    */
    ...
    _addToolbarButtons : function()
    {
      ...
      // set null button
      this._setNullButton = new qx.ui.toolbar.Button(null, "inspector/images/icons/setnull.png");
      ...
      this._setPropertyToDefaultButton = new qx.ui.toolbar.Button(null, "inspector/images/icons/setinit.png");
      ...
      this._highlightCurrentPropertyButton = new qx.ui.toolbar.Button(null, "inspector/images/icons/highlight.png");
      ...
      this._toolbar.add(this._highlightCurrentPropertyButton);  //EXPERIMENTAL

      // go to property button
      this._gotoSelectedPropertyButton = new qx.ui.toolbar.Button(null, "inspector/images/icons/goto.png");
      ...
      this._toolbar.add(this._gotoSelectedPropertyButton);  //EXPERIMENTAL
    },
    ...
    _switchPropertyButtons : function()
    {
      ...
      if (key != undefined) {
        try
        {
          ...
          if ((property.check == "qx.ui.core.Widget" || property.check == "qx.ui.core.Parent") && (this._qxObject.classname != "qx.ui.core.ClientDocument") && (value != null))
          {
    ...
    _gotoSelectedPropertyButtonEventListener : function() {
      ...
      if (this._qxObject.classname != "qx.ui.core.ClientDocument")
      {
        ...
        try
        {
          ...
          //this._model.setInspected(this._qxObject[getterName].call(this._qxObject));
  ...
  {
    this._qxObject = null;
    this._disposeObjects("_filter", "_model", "_menu", "_inheritedButton", "_groupButton", "_reloadButton", "_setNullButton", "_setPropertyToDefaultButton", "_highlightCurrentPropertyButton", "_gotoSelectedPropertyButton", "_propertyList");
  }
});
