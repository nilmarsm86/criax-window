 ...
 * List
 * 
 * @asset(silverbluetheme/demo/people.json)
 *
 */

qx.Class.define("silverbluetheme.demo.pages.List",
{
  ...
  construct: function()
  {
    ...
    this.__listUrl = qx.util.ResourceManager.getInstance().toUri("silverbluetheme/demo/people.json");
