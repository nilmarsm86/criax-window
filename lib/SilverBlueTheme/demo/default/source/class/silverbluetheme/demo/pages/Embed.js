 ...
 *
 *
 * @asset(silverbluetheme.demo/fo_tester.swf)
 * @asset(silverbluetheme.demo/blank.html)
 */

qx.Class.define("silverbluetheme.demo.pages.Embed",
{
  extend: silverbluetheme.demo.pages.AbstractPage,
  ...
  members:
  {
    ...
    initWidgets: function()
    {
      ...
      var flash = new qx.ui.embed.Flash("silverbluetheme/demo/fo_tester.swf").set({
        scale: "noscale",
        width: 100,
        height: 200,
        variables : flashVars
      ...
      var html1 = "<div style='background-color: #303030; text-align: center;'>" +
      ...
      richWidget.setDecorator("group");
      //~ richWidget.setBackgroundColor("input-end");
