...
qx.Class.define("silverbluetheme.demo.Application",
{
  ...
  members:
  {
    ...
    main: function()
    {
      ...
      var about = this.about = new silverbluetheme.demo.About();
      desktop.add(about);
    ...
    {
      var separator = new silverbluetheme.demo.Separator(80);
      
      var themeLabel = new qx.ui.basic.Label("SilverBlue").set({
        font: "title", 
    ...
    onCalculator: function(e)
    {
      ...
      {
        if (!that.calculator) {
          that.calculator = new silverbluetheme.demo.Calculator();
    ...
    onColorChooser: function(e)
    {
      ...
      this.dockButtonClick(button, this.colorChooser, function()
      {
        if (!that.colorChooser) {
          that.colorChooser = new silverbluetheme.demo.ColorChooser();
    ...
    onTableWindow: function(e)
    {
      ...
      {
        if (!that.tableWindow) {
          that.tableWindow = new silverbluetheme.demo.TableWindow();
    ...
    onWebBrowser: function(e)
    {
      ...
      {
        if (!that.webBrowser) {
          that.webBrowser = new silverbluetheme.demo.WebBrowser();
    ...
    onWidgetBrowser: function(e)
    {
      ...
      this.dockButtonClick(button, this.widgetBrowser, function()
      {
        if (!that.widgetBrowser) {
          that.widgetBrowser = new silverbluetheme.demo.WidgetBrowser();
    ...
    onAudioPlayerWindow: function(e)
    {
      ...
      this.dockButtonClick(button, this.audioPlayerWindow, function()
      {
        if (!that.audioPlayerWindow) {
          that.audioPlayerWindow = new silverbluetheme.demo.PlayerWindow();
    ...
    onOpenHomepage: function(e)
    {
      if (!this.homePageWindow) {
        this.homePageWindow = new silverbluetheme.demo.WebBrowser();
    ...
    onOpenWikipedia: function(e)
    {
      if (!this.wikipediaWindow) {
        this.wikipediaWindow = new silverbluetheme.demo.WebBrowser();
    ...
    {
      if (!this.videoWindow) {
        this.videoWindow = new silverbluetheme.demo.VideoWindow();
