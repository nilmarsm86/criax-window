...
qx.Class.define("silverbluetheme.demo.pages.Tab",
{
  ...
  members:
  {
    ...
    {
      var page1 = new qx.ui.tabview.Page("Layout", "icon/16/apps/utilities-terminal.png").set({showCloseButton: true});
      page1.setLayout(new qx.ui.layout.VBox());
      page1.add(new qx.ui.basic.Label("Layout-Settings…"));
      tabView.add(page1);

      var page2 = new qx.ui.tabview.Page("Notes", "icon/16/apps/utilities-notes.png").set({showCloseButton: true});
      page2.setLayout(new qx.ui.layout.VBox());
      page2.add(new qx.ui.basic.Label("Notes…"));
      tabView.add(page2);

      var page3 = new qx.ui.tabview.Page("Calculator", "icon/16/apps/utilities-calculator.png").set({showCloseButton: true});
