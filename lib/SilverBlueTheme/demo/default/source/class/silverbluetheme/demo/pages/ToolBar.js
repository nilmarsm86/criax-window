...
qx.Class.define("silverbluetheme.demo.pages.ToolBar",
{
  ...
  members:
  {
    initWidgets: function()
    {
      ...
      this.add(label, {left: 0, top: 360});
      this.add(this.getContextMenuWidget(), {left: 0, top: 380});
    ...
    getContextMenuWidget : function() {
      ...
      //~ w.setBackgroundColor("input-end");
      w.setDecorator("input");
      w.setMinHeight(100);
      w.setWidth(200);
