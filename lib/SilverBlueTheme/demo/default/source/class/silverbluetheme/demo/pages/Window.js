...
qx.Class.define("silverbluetheme.demo.pages.Window",
{
  ...
  members:
  {
    ...
    initWidgets: function()
    {
      ...
      widgets.push(w1);
      w1.open();
      this.__desktop.add(w1, {left: 0, top: 10});

      w2 = this.__createWindow2();
      widgets.push(w2);
      w2.open();
      this.__desktop.add(w2, {left: 300, top: 110});

      w3 = this.__createWindow3();
      widgets.push(w3);
      w3.open();
      this.__desktop.add(w3, {left: 70, top: 280});
    },
