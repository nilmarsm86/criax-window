 ...
 *
 *
 * @asset(bamboo.demo/fo_tester.swf)
 * @asset(bamboo.demo/blank.html)
 */

qx.Class.define("bamboo.demo.pages.Embed",
{
  ...
  members:
  {
    ...
    initWidgets: function()
    {
      ...
      var flash = new qx.ui.embed.Flash("bamboo/demo/fo_tester.swf").set({
        scale: "noscale",
        width: 100,
        height: 200,
        variables : flashVars
