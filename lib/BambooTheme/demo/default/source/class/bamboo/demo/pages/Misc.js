...
qx.Class.define("bamboo.demo.pages.Misc",
{
  ...
  construct: function()
  {
    ...
    this.__vbox = new qx.ui.container.Composite(new qx.ui.layout.VBox(10)).set({marginLeft: 10});
  ...
  members:
  {
    ...
    initWidgets: function()
    {
      ...
      var source = new qx.ui.form.List().set({
        draggable: true,
        quickSelection: true
      });
      for (var i = 0; i < 10; i++) {
        source.add(new qx.ui.form.ListItem("Item " + i, "bamboo/demo/icon/16/folder.png"));
      }
      ...
      source.addListener("droprequest", function(e) {
        ...
        var result;
        this.debug("droprequest: "+action+" | "+type);
      ...
      var target = new qx.ui.form.List().set({
        droppable: true
      });
