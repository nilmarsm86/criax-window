...
qx.Class.define("bamboo.demo.TableWindow",
{
  ...
  members:
  {
    ...
    _createControls: function()
    {
      this.set({
        ...
        contentPadding: 3,
        caption: "Table",
        icon: "bamboo/demo/icon/16/table-focused.png",
        allowStretchX: false,
        allowStretchY: false
      });
    ...
    createTable: function()
    {
      ...
      tcm.setHeaderCellRenderer(2, new qx.ui.table.headerrenderer.Icon("bamboo/demo/icon/16/calendar.png", "A date"));
    ...
    createToolbar: function()
    {
      ...
      button = new bamboo.demo.toolbar.Button("Change row with ID 10", "bamboo/demo/icon/16/reply.png", "bamboo/demo/icon/16/reply-focused.png");
      ...
      button = new bamboo.demo.toolbar.Button("Add 10 rows", "bamboo/demo/icon/16/plus.png", "bamboo/demo/icon/16/plus-focused.png");
      button.addListener("execute", function(evt) {
      ...
      button = new bamboo.demo.toolbar.Button("Remove 5 rows", "bamboo/demo/icon/16/minus.png", "bamboo/demo/icon/16/minus-focused.png");
      button.addListener("execute", function(evt) {
      ...
      button = new bamboo.demo.toolbar.Button("Show selection", "bamboo/demo/icon/16/info.png", "bamboo/demo/icon/16/info-focused.png");
      button.addListener("execute", function(evt)
      {
        var selection = [];
        ...
        alert("Selected rows:<br>" + selection.join(", "));
      }, this);
      part.add(button);
      ...
      checkBox.set({
        value: this._table.getKeepFirstVisibleRowComplete(),
      ...
      checkBox.addListener("changeValue", function(evt) {
        this._table.setKeepFirstVisibleRowComplete(this._checkBox1.getValue());
      }, this);
      part.add(checkBox);
      ...
      checkBox.addListener("changeValue", function(evt)
      {
        if (evt.getData()) {
          ...
          this._table.getTableModel().setSortMethods(0, {
            ascending  : ascending,
            descending : descending
          });
        } else {
          this._table.getTableModel().setSortMethods(0, null);
        }
      }, this);
      part.add(checkBox);
