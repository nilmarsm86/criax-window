...
qx.Class.define("bamboo.demo.pages.Tab",
{
  ...
  members:
  {
    ...
    {
      var page1 = new qx.ui.tabview.Page("Layout", "bamboo/demo/icon/16/desktop.png").set({showCloseButton: true});
      page1.setLayout(new qx.ui.layout.VBox());
      page1.add(new qx.ui.basic.Label("Layout-Settings…"));
      tabView.add(page1);

      var page2 = new qx.ui.tabview.Page("Notes", "bamboo/demo/icon/16/notes.png").set({showCloseButton: true});
      page2.setLayout(new qx.ui.layout.VBox());
      page2.add(new qx.ui.basic.Label("Notes…"));
      tabView.add(page2);

      var page3 = new qx.ui.tabview.Page("Calculator", "bamboo/demo/icon/16/calculator.png").set({showCloseButton: true});
