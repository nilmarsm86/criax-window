 /**  
  * Clase para las validacion de nulo
  * 
  * @class IsNull
...
qx.Class.define("validator.constraints.IsNull",
{   
    ...
    {   
        /**         
         * metodo para validar que el dato pasado sea nulo
         * 
         * @method validate
         * @public        
        ...
        validate : function(errorMessage) {            
            return function(value){
                var constraint = new validator.constraints.IsNull(value);                
