 /**  
  * Clase para las validacion de undefined
  * 
  * @class IsUndefined
...
qx.Class.define("validator.constraints.IsUndefined",
{   
    ...
    {   
        /**         
         * metodo para validar que el dato pasado sea undefined
         * 
         * @method validate
         * @public        
        ...
        validate : function(errorMessage) {            
            return function(value){
                var constraint = new validator.constraints.IsUndefined(value);                
    ...
    {
        this._message = "Debe ser indefinido!";                
        this._value = value;
