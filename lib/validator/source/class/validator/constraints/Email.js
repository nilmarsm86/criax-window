 /**  
  * Clase para las validacion de correo
  * 
  * @class Email
...
qx.Class.define("validator.constraints.Email",
{   
    ...
    {   
        /**         
         * metodo para validar que el dato pasado sea un correo
         * 
         * @method validate
         * @public        
        ...
        validate : function(errorMessage) {            
            return function(value){
                var constraint = new validator.constraints.Email(value);                
    ...
    {
        this._message = "Debe ser un correo!";
        this._pattern = /^([^@\s]+)@((?:[-a-z0-9]+\.)+[a-z]{2,})$/;        
        this._value = value;
    },
