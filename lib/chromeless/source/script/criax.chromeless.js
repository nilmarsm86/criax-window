...
var envinfo = {"chrome.accelerated":true,"chrome.background":"white","chrome.border":"0px solid #000","chrome.borderradius":"0px 0px 0px 0px","chrome.boxshadow":"0px 0px 0px #ccc","chrome.centerscreen":true,"chrome.chromemargin":"-1, -1, -1, -1","chrome.close":true,"chrome.disablechrome":false,"chrome.height":600,"chrome.hidechrome":false,"chrome.margin":"0px 0px 0px 0px","chrome.minimizable":true,"chrome.opacity":"1","chrome.padding":"0px 0px 0px 0px","chrome.resizable":true,"chrome.src":"index.html","chrome.title":"chromeless","chrome.titlebar":true,"chrome.transform":"rotate(0deg) skew(0deg, 0deg)","chrome.width":800,"criax.i18n":"es","criax.init.controller":"chromeless.controller.Controller","criax.init.domain":"criax.domain.ModelFacade","criax.init.view":"chromeless.view.View","criax.persistence.db.driver":"sqlite","criax.persistence.db.name":"","criax.persistence.db.path":"","criax.persistence.map.dir":"persistence","criax.persistence.map.name":"","criax.production":false,"criax.services.default":"services","criax.services.dir":"services","engine.name":"gecko","qx.application":"criax.chromeless.Application","qx.debug":true,"qx.debug.databinding":false,"qx.debug.dispose":true,"qx.debug.dispose.level":2,"qx.debug.io":true,"qx.debug.ui.queue":true,"qx.revision":"","qx.theme":"criax.chromeless.theme.Theme","qx.version":"5.0.2"};
for (var k in envinfo) qx.$$environment[k] = envinfo[k];

if (!qx.$$libraries) qx.$$libraries = {};
var libinfo = {"__out__":{"sourceUri":"script"},"criax.chromeless":{"resourceUri":"../source/resource","sourceUri":"../source/class"},"qx":{"resourceUri":"../../../criax/knl/qooxdoo/framework/source/resource","sourceUri":"../../../criax/knl/qooxdoo/framework/source/class","sourceViewUri":"https://github.com/qooxdoo/qooxdoo/blob/%{qxGitBranch}/framework/source/class/%{classFilePath}#L%{lineNumber}"}};
