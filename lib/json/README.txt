Vendor json de CRIAX-SDK
====================================================

Este es un library desarrollado con y para la plataforma CRIAX-SDK.

El mismo permite transformar un modelo Qx en un string json salvandolo en un archivo y vicevesa.
...
4- Hacer uso de las clases del library json en la aplicación (Leer documentación y API).
