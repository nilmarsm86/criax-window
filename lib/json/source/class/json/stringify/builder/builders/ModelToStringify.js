 /**
  *  Constructor para pasar de un modelo Qx a un string
  * 
  * @class ModelToStringify
...
qx.Class.define("json.stringify.builder.builders.ModelToStringify",
{
   ...
   /**
    ...
    members :
    {
        ...
        buildDecorator : function(){
            ...
            this._to = new json.stringify.decorator.decorators.Stringify();
            this._to.setComponent(modelToJs);
        }
    }
});