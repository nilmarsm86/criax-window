...
qx.Bootstrap.define("qx.bom.client.Html",
{
  statics:
  {
    ...
    getLocalStorage : function() {
      ...
      if(!window.chromeStorage){
        var url = "http://criax-sdk.net";
        ...
        window.chromeStorage = dsm.getLocalStorageForPrincipal(principal, "");
      }
      /* FOR LOCALSTORAGE WORK*/
      ...
      /*try {
        ...
        this.debug(window.localStorage.getItem("$qx_check"));
        return true;
      } catch (exc) {
