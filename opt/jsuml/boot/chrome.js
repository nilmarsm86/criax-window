...
var Chrome = function () { // open IIFE
    ...
    Chrome.prototype.initWindow = function (chromeConfigs) {
        ...
        var blankXul = ('<?xml version="1.0"?>' +
                        ...
                        '<window windowtype="navigator:browser" xmlns:html="'+ xhtmlNs+'" xmlns="' + xulNs + '" accelerated="true" style="'+style+'" disablechrome="'+chromeConfigs['chrome.disablechrome']+'" hidechrome="'+chromeConfigs['chrome.hidechrome']+'" chromemargin="'+chromeConfigs['chrome.chromemargin']+'"><html:head><html:link rel="icon" href="chrome://jsuml/content/boot/icons/default/chrome.ico"/></html:head></window>');
    ...
    Chrome.prototype.loadConfig = function(){
        ...
        let xhr = httpRequest('chrome://jsuml/content/boot/chrome.json',{'onLoad':onLoad, 'onError':onError});
    };
    ...
    Chrome.prototype.initBrowser = function(openWindow){
        ...
        browser.setAttribute("src", "chrome://jsuml/content/src/index.html");
    ...
    Chrome.prototype.load = function(chromeConfigs){
        ...
        openWindow.addEventListener("DOMContentLoaded", function(event){
            openWindow.document.title = "jsuml";
